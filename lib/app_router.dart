...
import 'package:yamata_launcher/ui/pages/settings/site_cookies/site_cookies_page.dart';
      ...
      routes: [
        ...
        GoRoute(
          ...
          routes: [
            GoRoute(
              path: 'site-cookies',
              builder: (context, state) => SiteCookiesPage(),
            ),
            GoRoute(
            ...
            GoRoute(
              path: 'game-runners-settings',
              builder: (context, state) => GameRunnersSettingsPage(),
            ),
            GoRoute(
